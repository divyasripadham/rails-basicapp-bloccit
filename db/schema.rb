...
ActiveRecord::Schema.define(version: 20151025205812) do
  ...
  create_table "ratingjunctions", force: :cascade do |t|
    t.integer  "rating_id"
    t.integer  "topic_id"
    t.integer  "post_id"
  ...
  add_index "ratingjunctions", ["post_id"], name: "index_ratingjunctions_on_post_id"
  add_index "ratingjunctions", ["rateable_type", "rateable_id"], name: "index_ratingjunctions_on_rateable_type_and_rateable_id"
  add_index "ratingjunctions", ["rating_id"], name: "index_ratingjunctions_on_rating_id"
  add_index "ratingjunctions", ["topic_id"], name: "index_ratingjunctions_on_topic_id"
